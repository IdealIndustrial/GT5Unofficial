package idealindustrial.impl.entity;
...
public class CubeRenderedParticle extends EntityFX {
    private final IIcon[][] icons = new IIcon[6][];
    private boolean texturesAreSet = false;

    public CubeRenderedParticle(World world, int x, int y, int z, IGuideRenderer renderer) {
    ...
    public CubeRenderedParticle(World world, Vector3 position, IGuideRenderer renderer) {
    ...
    public CubeRenderedParticle setTextures(IIcon[] icons) {
        for (int i = 0; i < 6; i++) {
    ...
    public CubeRenderedParticle setTextures(ITexture[][] textures) {
        for (int i = 0; i < 6; i++) {
