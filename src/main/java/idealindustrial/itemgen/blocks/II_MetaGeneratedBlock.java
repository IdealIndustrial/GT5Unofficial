...
import idealindustrial.itemgen.blocks.base.II_MetaBlock;
...
public class II_MetaGeneratedBlock extends II_MetaBlock {

    private final IIconContainer[] icons;
    protected final II_Material[] materials;
    protected final int[] colors;
    protected int subID;
    public II_MetaGeneratedBlock(String type, int subID, Material material, SoundType soundType) {
        super(II_MetaBlock_Item.class, "metagenerated." + type + "." + subID, material);
