...
public class NetworkedTexture implements INetworkedTexture {
    ...
    public NetworkedTexture(IIconContainer mIconContainer, boolean mAllowAlpha, short[] mRGBa) {
        this.mIconContainer = mIconContainer;
        this.mAllowAlpha = mAllowAlpha;
        this.mRGBa = mRGBa;
        this.id = TextureManager.INSTANCE.registerNetworkedTexture(this);
    }

    public NetworkedTexture(IIconContainer aIcon, short[] aRGBa) {
        this(aIcon, true, aRGBa);
    }

    public NetworkedTexture(IIconContainer aIcon) {
        this(aIcon, Dyes._NULL.mRGBa);
    }

    public NetworkedTexture(GT_RenderedTexture renderedTexture) {
        this(renderedTexture.getContainer(), true, renderedTexture.getRGBA());
    }
