...
public class PacketCover extends GT_Packet {
    ...
    public PacketCover(HostTile tile, int side, int coverID, long coverValue) {
        super(false);
    ...
    public void process(IBlockAccess aWorld) {
        if (aWorld != null) {
            ...
            if (baseTile instanceof HostTileImpl) {
                ((HostTileImpl) baseTile).setCoverAtSide(side, coverID, coverValue);
            }
        }
    }
