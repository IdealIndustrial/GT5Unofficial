...
public abstract class BaseMetaTile<BaseTileType extends BaseTile> implements MetaTile<BaseTileType> {

    protected ITexture textureActive, textureInactive;
    protected BaseTileType baseTile;

    public BaseMetaTile(BaseTileType baseTile, ITexture textureInactive, ITexture textureActive) {
