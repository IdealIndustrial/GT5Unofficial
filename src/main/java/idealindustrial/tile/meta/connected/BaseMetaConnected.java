...
import static idealindustrial.tile.TileEvents.CONNECTIONS;

/**
 * basic class for cable systems tiles
 * has textures, 0 - inactive, 1 - active;
 */
public abstract class BaseMetaConnected<BaseTileType extends BaseTile> extends BaseMetaTile<BaseTileType> {
    protected int connections = 0;//shitty bitmask to save some space
    protected float thickness = 0.5f;

    public BaseMetaConnected(BaseTileType baseTile, ITexture textureInactive, ITexture textureActive) {
