...
public class II_MultipartRecipedInternalInventory extends II_MultipartInternalInventory implements II_RecipedInventory {
    @Override
    ...
    public int extractByOre(II_HashedStack is, int amount, String ore, boolean doExtract) {
