...
public class II_InternalInventoryWrapper implements IInventory {

    protected II_InternalInventory internalInventory;

    public II_InternalInventoryWrapper(II_InternalInventory internalInventory) {
