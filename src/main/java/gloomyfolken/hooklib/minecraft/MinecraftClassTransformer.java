...
public class MinecraftClassTransformer extends HookClassTransformer implements IClassTransformer {
    ...
    public static HashMap<Integer, String> loadMethodNames() throws IOException {
        InputStream resourceStream = MinecraftClassTransformer.class.getResourceAsStream("/gloomyfolken/hooklib/minecraft/methods.bin");
