...
//		checkCellBalance();
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sFermentingBarrelRecipes = new GT_Recipe_Map(new HashSet<>(50), "gt.recipe.fermenting_barrel", "Fermenting Barrel (WIP)", null, RES_PATH_GUI + "basicmachines/Default", 0, 0, 0,1, 1, E, 1, E, false, true);
