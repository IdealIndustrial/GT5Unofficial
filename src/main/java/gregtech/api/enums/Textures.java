...
public class Textures {
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        STEAM_TURBINE_BOTTOM_ACTIVE, STEAM_TURBINE_TOP_ACTIVE, BLOCK_BRONZEPREIN, BLOCK_IRREIN, BLOCK_PLASCRETE, BLOCK_PLASCRETE_WINDOW, BLOCK_TSREIN, OVERLAY_LOCKER, OVERLAY_LOCKER_000, OVERLAY_LOCKER_001,
        ...
        OVERLAY_LOCKER_011, OVERLAY_LOCKER_012, OVERLAY_LOCKER_013, OVERLAY_LENS, OVERLAY_PIPE, OVERLAY_PIPE_IN, OVERLAY_PIPE_OUT, OVERLAY_FLUID_OUT, OVERLAY_MUFFLER, OVERLAY_CONTROLLER, OVERLAY_ACTIVITYDETECTOR,
        OVERLAY_ENERGYDETECTOR, OVERLAY_FLUIDDETECTOR, OVERLAY_PLAYERDETECTOR, OVERLAY_TRANSMITTEREXTERNAL, OVERLAY_TRANSMITTERINTERNAL, OVERLAY_RECEIVEREXTERNAL, OVERLAY_RECEIVERINTERNAL, OVERLAY_NEEDSMAINTAINANCE, 
        OVERLAY_ITEMDETECTOR, OVERLAY_FUSION1, OVERLAY_FUSION2, OVERLAY_FUSION3, OVERLAY_SCREEN, OVERLAY_QTANK, OVERLAY_QCHEST, OVERLAY_SHUTTER,
        ...
        OVERLAY_FRONT_ROCK_BREAKER_ACTIVE, OVERLAY_FRONT_SCANNER_ACTIVE, OVERLAY_PRIMITIVE_MINER, OVERLAY_PRIMITIVE_MINER_DRILL, OVERLAY_PRIMITIVE_MINE_DIGGER_DRILL, OVERLAY_PRIMITIVE_MINE_DIGGER, OVERLAY_BOTTOM_POTIONBREWER_ACTIVE, OVERLAY_BOTTOM_REPLICATOR_ACTIVE, OVERLAY_BOTTOM_MASSFAB_ACTIVE,
        ...
        OVERLAY_WATERPROOF,
        MACHINE_CASING_PUMP_ULV, MACHINE_CASING_PUMP_LV, MACHINE_CASING_PUMP_MV, MACHINE_CASING_PUMP_HV, MACHINE_CASING_PUMP_EV, MACHINE_CASING_PUMP_IV,
        MACHINE_CASING_PUMP_FILTER_ULV, MACHINE_CASING_PUMP_FILTER_LV, MACHINE_CASING_PUMP_FILTER_MV, MACHINE_CASING_PUMP_FILTER_HV, MACHINE_CASING_PUMP_FILTER_EV, MACHINE_CASING_PUMP_FILTER_IV,
        MACHINE_CASING_PUMP_FILTER_ULV_UP, MACHINE_CASING_PUMP_FILTER_LV_UP, MACHINE_CASING_PUMP_FILTER_MV_UP, MACHINE_CASING_PUMP_FILTER_HV_UP, MACHINE_CASING_PUMP_FILTER_EV_UP, MACHINE_CASING_PUMP_FILTER_IV_UP,
        OVERLAY_PRIMITIVE_PUMP_ACTIVE, OVERLAY_PRIMITIVE_PUMP_INACTIVE, OVERLAY_ELECTRIC_PUMP_ACTIVE, OVERLAY_ELECTRIC_PUMP_INACTIVE, OVERLAY_CREATIVE_WATERLOADER,
        ...
        public static ITexture[]
                ...
                WOODEN_CASINGS = new GT_RenderedTexture[]{
                        ...
                        new GT_RenderedTexture(new Textures.BlockIcons.CustomIcon("basicmachines/wooden_casing/TOP")),
                        new GT_RenderedTexture(new Textures.BlockIcons.CustomIcon("basicmachines/wooden_casing/SIDE")),
                        new GT_RenderedTexture(new Textures.BlockIcons.CustomIcon("basicmachines/wooden_casing/FRONT")),
                        new GT_RenderedTexture(new Textures.BlockIcons.CustomIcon("basicmachines/wooden_casing/BOTTOM_ACTIVE")),
                        new GT_RenderedTexture(new Textures.BlockIcons.CustomIcon("basicmachines/wooden_casing/TOP_ACTIVE")),
                        new GT_RenderedTexture(new Textures.BlockIcons.CustomIcon("basicmachines/wooden_casing/SIDE_ACTIVE")),
                        new GT_RenderedTexture(new Textures.BlockIcons.CustomIcon("basicmachines/wooden_casing/FRONT_ACTIVE"))
                };
