		...
		if (recipeDesc == null) {
			if (tEUt != 0) {
				...
				if (this.mRecipeMap.mShowVoltageAmperageInNEI) {
					drawText(10, 93, trans("154","Voltage: ") + GT_Utility.formatNumbers(tEUt / this.mRecipeMap.mAmperage) + " EU ("+GT_Values.VN[GT_Utility.getTier(tEUt / this.mRecipeMap.mAmperage)]+")", -16777216);
