...
public class ProcessingDye implements IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        if ((aDye.mIndex >= 0) && (aDye.mIndex < 16) &&
            ...
            GT_Values.RA.addChemicalRecipe(GT_Utility.copyAmount(4L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.PolyvinylAcetate, 1), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Acetone, 1), FluidRegistry.getFluidStack("dye.chemical." + aDye.name().toLowerCase(Locale.ENGLISH), 1728), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Empty, 1), 400, 16);
            GT_Values.RA.addChemicalRecipe(GT_Utility.copyAmount(4L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.PolyvinylAcetate, 1), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.MethylAcetate, 1), FluidRegistry.getFluidStack("dye.chemical." + aDye.name().toLowerCase(Locale.ENGLISH), 1728), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Empty, 1), 400, 16);
        }
    }
}
