...
//            GameRegistry.addRecipe(GT_OreDictUnificator.get(OrePrefixes.paper, Materials.Empty, 2), " C ", "SSS", " C ", 'S', GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Paper, 1), 'C', brick);
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Tool_DataReader.get(1L), bits, new Object[]{"PBP","CSC","PWP", 'P', OrePrefixes.plate.get(Materials.Aluminium), 'W', OrePrefixes.cableGt01.get(Materials.Copper), 'B', ItemList.Battery_RE_MV_Lithium,	'S', ItemList.Cover_Screen, 'C', OrePrefixes.circuit.get(Materials.Good)});	    
    }
}
