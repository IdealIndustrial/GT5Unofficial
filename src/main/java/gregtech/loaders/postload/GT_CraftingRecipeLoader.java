...
//            GameRegistry.addRecipe(GT_OreDictUnificator.get(OrePrefixes.paper, Materials.Empty, 2), " C ", "SSS", " C ", 'S', GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Paper, 1), 'C', brick);
        ...
        long bitr = GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.REVERSIBLE | GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE;
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.PrimitiveFluidFilterItem.get(1L), bitr, new Object[]{"PSP","WOW","PSP", 'P', OrePrefixes.plate.get(Materials.Paper), 'S', new ItemStack(Items.string,1), 'W', new ItemStack(Blocks.wool, 1, GT_Values.W), 'O', OrePrefixes.pipeMedium.get(Materials.Wood) });
        GT_ModHandler.addCraftingRecipe(ItemList.Casing_Filter_ULV.get(1L), bitr, new Object[]{"RFR","FPF","RFR", 'R', OrePrefixes.ring.get(Materials.Tin), 'F', ItemList.PrimitiveFluidFilterItem.get(1L), 'P', OrePrefixes.pipeMedium.get(Materials.Wood)});
