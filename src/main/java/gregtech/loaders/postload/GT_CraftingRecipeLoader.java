...
//            GameRegistry.addRecipe(GT_OreDictUnificator.get(OrePrefixes.paper, Materials.Empty, 2), " C ", "SSS", " C ", 'S', GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Paper, 1), 'C', brick);
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Machine_Well.get(1L), bits, new Object[]{"SPS","WQW","BVB",'S',GT_OreDictUnificator.get(OrePrefixes.gearGt,Materials.Wood,1),'P', new ItemStack(Items.stick,1),'W', GT_OreDictUnificator.get(OrePrefixes.plank, Materials.Wood),'Q', new ItemStack(Items.string,1), 'B', OrePrefixes.stoneCobble, 'V',new ItemStack(Items.bucket,1)});
    }
}
