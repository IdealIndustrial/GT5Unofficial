...
//        Quantumsuite
	...
	GT_Values.RA.addMixerRecipe(new ItemStack(Blocks.sand, 1), Materials.Coal.getDustSmall(1), Materials.Saltpeter.getDust(1), GT_Values.NI, Materials.Oil.getFluid(160), GT_Values.NF, new ItemStack(Blocks.soul_sand), 100, 16);
        ...
        GT_Values.RA.addChemicalRecipe(Materials.Glycerol.getCells(1),                            GT_Utility.getIntegratedCircuit(1),  Materials.NitrationMixture.getFluid(3000), Materials.DilutedSulfuricAcid.getFluid(6000), Materials.Glyceryl.getCells(1), 180);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Glycerol.getCells(1),         Materials.Empty.getCells(5),        Materials.NitrationMixture.getFluid(3000), Materials.Glyceryl.getFluid(1000),            Materials.DilutedSulfuricAcid.getCells(6), GT_Values.NI, 180, 30);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.NitrationMixture.getCells(3), Materials.Empty.getCells(3),        Materials.Glycerol.getFluid(1000),         Materials.Glyceryl.getFluid(1000),            Materials.DilutedSulfuricAcid.getCells(6), GT_Values.NI, 180, 30);
