...
//        Quantumsuite
	...
	if (tMat.mStandardMoltenFluid != null && tMat.contains(SubTag.SOLDERING_MATERIAL) && !(GregTech_API.mUseOnlyGoodSolderingMaterials && !tMat.contains(SubTag.SOLDERING_MATERIAL_GOOD))) {
	int tMultiplier = tMat.contains(SubTag.SOLDERING_MATERIAL_GOOD) ? 1 : tMat.contains(SubTag.SOLDERING_MATERIAL_BAD) ? 4 : 2;		
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("minecraft", "sapling", 16L, 0), OrePrefixes.circuit.get(Materials.Good), 1, tMat.getMolten(144L * tMultiplier / 2L), 	ItemList.OakScheme.get(1L), 200, 30);
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("minecraft", "sapling", 16L, 1), OrePrefixes.circuit.get(Materials.Good), 1, tMat.getMolten(144L * tMultiplier / 2L), 	ItemList.SpruceScheme.get(1L), 200, 30);
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("minecraft", "sapling", 16L, 2), OrePrefixes.circuit.get(Materials.Good), 1, tMat.getMolten(144L * tMultiplier / 2L), 	ItemList.BirchScheme.get(1L), 200, 30);
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("minecraft", "sapling", 16L, 3), OrePrefixes.circuit.get(Materials.Good), 1, tMat.getMolten(144L * tMultiplier / 2L), 	ItemList.JungleScheme.get(1L), 200, 30);
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("minecraft", "sapling", 16L, 4), OrePrefixes.circuit.get(Materials.Good), 1, tMat.getMolten(144L * tMultiplier / 2L), 	ItemList.AcaciaScheme.get(1L), 200, 30);
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("minecraft", "sapling", 16L, 5), OrePrefixes.circuit.get(Materials.Good), 1, tMat.getMolten(144L * tMultiplier / 2L), 	ItemList.DarkOakScheme.get(1L), 200, 30);
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("IC2", "blockRubSapling", 16L, 0), OrePrefixes.circuit.get(Materials.Good), 1, tMat.getMolten(144L * tMultiplier / 2L), 	ItemList.RubberScheme.get(1L), 200, 30);		
		}
	}
	...
	GT_Values.RA.addMixerRecipe(ItemList.FR_Compost.get(1L, new Object[0]), new ItemStack(Blocks.sand, 2, 32767), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, ItemList.FR_Fertilizer.get(4L, new Object[0]), 64, 16);
