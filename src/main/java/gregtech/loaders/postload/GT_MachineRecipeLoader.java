...
//Circuit Recipes!!!
	...
	//Pumps
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Aluminium, 1L)}, Materials.Plastic.getMolten(36), ItemList.Tool_CD.get(4L, new Object[0]), 480, 16); // CD recipe
