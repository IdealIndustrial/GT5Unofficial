...
//			GT_Values.RA.addChemicalRecipe(Materials.Water.getCells(1), GT_Values.NI, Materials.HydricSulfide.getGas(1000), Materials.DilutedSulfuricAcid.getFluid(2000), Materials.Empty.getCells(1), 60);
	...
	GT_Values.RA.addCentrifugeRecipe(new ItemStack(Blocks.pumpkin, 16, 0), GT_Values.NI, GT_Values.NF, Materials.Methane.getGas(576L), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, null, 4608, 5);
        ...
        GT_Values.RA.addRockBreakerRecipe(null, 1, new ItemStack(Blocks.cobblestone,  1, 0), 20, 30);
        GT_Values.RA.addRockBreakerRecipe(null, 2, new ItemStack(Blocks.cobblestone,  8, 0), 160, 30);
        GT_Values.RA.addRockBreakerRecipe(null, 3, new ItemStack(Blocks.cobblestone, 64, 0), 1280, 30);

        GT_Values.RA.addRockBreakerRecipe(null, 11, new ItemStack(Blocks.stone,  1, 0), 20, 30);
        GT_Values.RA.addRockBreakerRecipe(null, 12, new ItemStack(Blocks.stone,  8, 0), 160, 30);
        GT_Values.RA.addRockBreakerRecipe(null, 13, new ItemStack(Blocks.stone, 64, 0), 1280, 30);

        GT_Values.RA.addRockBreakerRecipe(new ItemStack(Items.redstone,  1, 0), 21, new ItemStack(Blocks.obsidian,  1, 0), 20, 30);
        GT_Values.RA.addRockBreakerRecipe(new ItemStack(Items.redstone,  8, 0), 22, new ItemStack(Blocks.obsidian,  8, 0), 160, 30);
        GT_Values.RA.addRockBreakerRecipe(new ItemStack(Items.redstone, 64, 0), 23, new ItemStack(Blocks.obsidian, 64, 0), 1280, 30);		
