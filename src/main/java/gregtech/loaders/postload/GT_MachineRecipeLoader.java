...
if(Loader.isModLoaded("Railcraft")){
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 3), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Cerium, 3), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Lanthanum, 3), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.NeodymiumMagnetic, 6), ItemList.Emitter_LV.get(6, new Object(){}), ItemList.Field_Generator_LV.get(1, new Object[0]), 1800, 30);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 6), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Cerium, 6), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Lanthanum, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.NeodymiumMagnetic, 12), ItemList.Emitter_MV.get(6, new Object(){}), ItemList.Field_Generator_MV.get(1, new Object[0]), 1800, 120);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Osmium, 6), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Cerium, 6), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Lanthanum, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.NeodymiumMagnetic, 24), ItemList.Emitter_HV.get(6, new Object(){}), ItemList.Field_Generator_HV.get(1, new Object[0]), 1800, 480);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Osmium, 12), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Cerium, 12), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Lanthanum, 12), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.NeodymiumMagnetic, 32), ItemList.Emitter_EV.get(6, new Object(){}), ItemList.Field_Generator_EV.get(1, new Object[0]), 1800, 1920);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Osmium, 6), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Cerium, 6), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Lanthanum, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.NeodymiumMagnetic, 48), ItemList.Emitter_IV.get(6, new Object(){}), ItemList.Field_Generator_IV.get(1, new Object[0]), 1800, 7680);
