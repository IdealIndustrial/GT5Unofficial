...
//        Quantumsuite
	...
	private void addChemicalRecipesComplicated(){
        ...
        GT_Values.RA.addChemicalRecipe(                   Materials.Chlorine.getCells(2), Materials.Empty.getCells(3),  Materials.Water.getFluid(6000),  Materials.HypochlorousAcid.getFluid(3000),        Materials.DilutedHydrochloricAcid.getCells(5), GT_Values.NI, 120);
        GT_Values.RA.addChemicalRecipe(                   Materials.Water.getCells(6),    GT_Utility.getIntegratedCircuit(1),  Materials.Chlorine.getGas(2000), Materials.HypochlorousAcid.getFluid(3000),        Materials.DilutedHydrochloricAcid.getCells(5), Materials.Empty.getCells(1), 120);
        ...
        GT_Values.RA.addChemicalRecipe(                   Materials.Chloroform.getCells(5),       Materials.Water.getCells(9), GT_Utility.getIntegratedCircuit(11),    Materials.HydrofluoricAcid.getFluid(4000), Materials.DilutedHydrochloricAcid.getFluid(15000), Materials.Tetrafluoroethylene.getCells(6),     Materials.Empty.getCells(8), Materials.Carbon.getDust(1),480, 240);
//        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Chloroform.getCells(5),     Materials.HydrofluoricAcid.getCells(8), null, Materials.Water.getFluid(9000),                              GT_Values.NF,                                     Materials.Tetrafluoroethylene.getCells(6),     Materials.DilutedHydrochloricAcid.getCells(6), Materials.Empty.getCells(2),480, 240);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(24)}, new FluidStack[]{Materials.HydrofluoricAcid.getFluid(8000), Materials.Methane.getGas(5000), Materials.Chlorine.getGas(6000), Materials.Water.getFluid(18000)}, new FluidStack[]{Materials.Tetrafluoroethylene.getGas(6000),  Materials.DilutedHydrochloricAcid.getFluid(30000)}, new ItemStack[]{Materials.Carbon.getDust(1)}, 540, 240);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{Materials.Silicon.getDust(1), GT_Utility.getIntegratedCircuit(24)}, new FluidStack[]{Materials.Methanol.getFluid(12000), Materials.HydrochloricAcid.getFluid(4000), Materials.Water.getFluid(3000)},                    new FluidStack[]{Materials.DilutedHydrochloricAcid.getFluid(10000)}, new ItemStack[]{Materials.Polydimethylsiloxane.getDust(10)}, 480, 96);
...
//        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Dimethylamine.getCells(10), Materials.Chloramine.getCells(2),    Materials.Chloramine.getFluid(2000),  Materials.DilutedHydrochloricAcid.getFluid(1000),  Materials.Dimethylhydrazine.getCells(6),       Materials.DilutedHydrochloricAcid.getCells(1), 960, 480);
	...
	GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(24)},new FluidStack[]{Materials.Ethylene.getGas(6000), Materials.Oxygen.getGas(1000), Materials.HydrochloricAcid.getFluid(2000)}, new FluidStack[]{Materials.VinylChloride.getGas(6000)}, null, 160, 30);	
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(24)}, new FluidStack[]{Materials.Benzene.getFluid(12000), Materials.Chlorine.getGas(2000), Materials.Water.getFluid(6000)}, new FluidStack[]{Materials.Phenol.getFluid(13000), Materials.HydrochloricAcid.getFluid(2000), Materials.DilutedHydrochloricAcid.getFluid(5000)}, null, 560, 30);
	...
	private void addChemicalRecipesShared(){
        ...
        GT_Values.RA.addChemicalRecipe(                   Materials.Ethanol.getCells(9),      GT_Utility.getIntegratedCircuit(1),  Materials.SulfuricAcid.getFluid(6000), Materials.DilutedSulfuricAcid.getFluid(10000), Materials.Ethylene.getCells(6), Materials.Empty.getCells(3), 1200, 120);
        GT_Values.RA.addChemicalRecipe(                   Materials.SulfuricAcid.getCells(6), GT_Utility.getIntegratedCircuit(1),  Materials.Ethanol.getFluid(9000),      Materials.DilutedSulfuricAcid.getFluid(10000), Materials.Ethylene.getCells(6), 1200, 120);
        GT_Values.RA.addChemicalRecipe(                   Materials.Ethanol.getCells(9),      Materials.Empty.getCells(1), Materials.SulfuricAcid.getFluid(6000), Materials.Ethylene.getGas(6000), Materials.DilutedSulfuricAcid.getCells(10),   GT_Values.NI, 1200, 120);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.SulfuricAcid.getCells(6), Materials.Empty.getCells(4),         Materials.Ethanol.getFluid(9000),      Materials.Ethylene.getGas(6000), Materials.DilutedSulfuricAcid.getCells(10),   GT_Values.NI, 1200, 120);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Ethanol.getCells(9),      Materials.SulfuricAcid.getCells(6), Materials.Empty.getCells(1), GT_Values.NF,                          GT_Values.NF,                    Materials.DilutedSulfuricAcid.getCells(10),   Materials.Ethylene.getCells(6), 1200, 120);
...
//        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Glycerol.getCells(7),          Materials.Empty.getCells(3),         Materials.NitrationMixture.getFluid(18000), Materials.DilutedSulfuricAcid.getFluid(15000), Materials.Glyceryl.getCells(10), GT_Values.NI, 1200, 30);
        GT_Values.RA.addChemicalRecipe(Materials.Nitrogen.getCells(1), Materials.NitrationMixture.getCells(18),                    GT_Utility.getIntegratedCircuit(1),  Materials.Glycerol.getFluid(7000),          Materials.DilutedSulfuricAcid.getFluid(12500), Materials.Glyceryl.getCells(10), Materials.Empty.getCells(9), 1200, 30);
//        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.NitrationMixture.getCells(18), GT_Utility.getIntegratedCircuit(11), Materials.Glycerol.getFluid(7000),          Materials.Glyceryl.getFluid(10000),            Materials.DilutedSulfuricAcid.getCells(15), GT_Values.NI, 1200, 30);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Nitrogen.getCells(1), Materials.NitrationMixture.getCells(18), Materials.Glycerol.getCells(7),      null,                                       Materials.DilutedSulfuricAcid.getFluid(12500), Materials.Glyceryl.getCells(10), Materials.Empty.getCells(16), 1200, 30);
