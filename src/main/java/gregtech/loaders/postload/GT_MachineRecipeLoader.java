...
//        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gunpowder, 4L), new ItemStack(Blocks.sand, 4, 32767), new ItemStack(Blocks.tnt, 1), 400, 1);
	...
	//Reed to PlantBall
        ...
        GT_Values.RA.addCompressorRecipe(GT_Utility.getIntegratedCircuit(0), Materials.Air.getGas(1000), 300, 2);
        GT_Values.RA.addCompressorRecipe(GT_Utility.getIntegratedCircuit(1), Materials.Air.getGas(1000), 30, 30);
