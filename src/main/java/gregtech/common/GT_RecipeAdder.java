...
public class GT_RecipeAdder implements IGT_RecipeAdder {
    ...
    public boolean addCompressorRecipe(ItemStack aCircuit, FluidStack fOutput, int aDuration, int aEUt) {
        ...
        if (((aDuration = GregTech_API.sRecipeFile.get("compressor", aCircuit, aDuration)) <= 0)) {
            return false;
        }
    ...
    public boolean addChemicalRecipeForBasicMachineOnly(ItemStack aInput1, ItemStack aInput2, ItemStack aInput3, FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack aOutput, ItemStack aOutput2, int aDuration, int aEUtick) {
        ...
        GT_Recipe.GT_Recipe_Map.sChemicalRecipes.addRecipe(true, new ItemStack[]{aInput1, aInput2, aInput3}, new ItemStack[]{aOutput, aOutput2}, null, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput}, aDuration, aEUtick, 0);
        return true;
    }
    ...
    public boolean addChemicalRecipeForBasicMachineOnly(ItemStack aInput1, ItemStack aInput2, ItemStack aInput3, FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack aOutput, ItemStack aOutput2, ItemStack aOutput3, int aDuration, int aEUtick) {
        ...
        GT_Recipe.GT_Recipe_Map.sChemicalRecipes.addRecipe(true, new ItemStack[]{aInput1, aInput2, aInput3}, new ItemStack[]{aOutput, aOutput2, aOutput3}, null, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput}, aDuration, aEUtick, 0);
        return true;
    }
    ...
    public boolean addChemicalRecipe(ItemStack aInput1, ItemStack aInput2, ItemStack aInput3, FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack aOutput, ItemStack aOutput2, int aDuration, int aEUtick) {
        ...
        GT_Recipe.GT_Recipe_Map.sChemicalRecipes.addRecipe(true, new ItemStack[]{aInput1, aInput2, aInput3}, new ItemStack[]{aOutput, aOutput2}, null, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput}, aDuration, aEUtick, isAddingDeprecatedRecipes ? -300 : 0);
        if (!(aInput1 != null && aInput1.getItem() instanceof GT_IntegratedCircuit_Item && aInput1.getItemDamage() >= 10)
                && !(aInput2 != null && aInput2.getItem() instanceof GT_IntegratedCircuit_Item && aInput2.getItemDamage() >= 10)) {
            GT_Recipe.GT_Recipe_Map.sMultiblockChemicalRecipes.addRecipe(false, new ItemStack[]{aInput1, aInput2, aInput3}, new ItemStack[]{aOutput, aOutput2}, null, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput}, aDuration, aEUtick, isAddingDeprecatedRecipes ? -300 : 0);
        }
        return true;
    }
    ...
    public boolean addChemicalRecipe(ItemStack aInput1, ItemStack aInput2, ItemStack aInput3, FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack aOutput, ItemStack aOutput2, ItemStack aOutput3, int aDuration, int aEUtick) {
        ...
        GT_Recipe.GT_Recipe_Map.sChemicalRecipes.addRecipe(true, new ItemStack[]{aInput1, aInput2, aInput3}, new ItemStack[]{aOutput, aOutput2, aOutput3}, null, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput}, aDuration, aEUtick, isAddingDeprecatedRecipes ? -300 : 0);
        if (!(aInput1 != null && aInput1.getItem() instanceof GT_IntegratedCircuit_Item && aInput1.getItemDamage() >= 10)
                && !(aInput2 != null && aInput2.getItem() instanceof GT_IntegratedCircuit_Item && aInput2.getItemDamage() >= 10)
                && !(aInput3 != null && aInput3.getItem() instanceof GT_IntegratedCircuit_Item && aInput3.getItemDamage() >= 10)) {
            GT_Recipe.GT_Recipe_Map.sMultiblockChemicalRecipes.addRecipe(false, new ItemStack[]{aInput1, aInput2, aInput3}, new ItemStack[]{aOutput, aOutput2, aOutput3}, null, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput}, aDuration, aEUtick, isAddingDeprecatedRecipes ? -300 : 0);
        }
        return true;
    }
    ...
    /**
     * For extending Alloy Smelter recipes using more than default 2 slots
     *
     * @param aInputs
     * @param aOutput
     * @param aDuration
     ...
     */
    @Override
    public boolean addAlloySmelterRecipe(ItemStack[] aInputs, ItemStack aOutput, int aDuration, int aEUt) {
        if (aInputs.length > GT_Recipe.GT_Recipe_Map.sAlloySmelterRecipes.mUsualInputCount || aInputs.length < GT_Recipe.GT_Recipe_Map.sAlloySmelterRecipes.mMinimalInputItems) {
            return false;
        }
        GT_Recipe.GT_Recipe_Map.sAlloySmelterRecipes.addRecipe(true, aInputs, new ItemStack[]{aOutput}, null, null, null, aDuration, aEUt, 0);
        return true;
    }
    ...
    public boolean addCNCRecipe(ItemStack aInput1, ItemStack aOutput1, int aDuration, int aEUt) {
        if (aInput1 == null || aOutput1 == null || GregTech_API.sRecipeFile.get("cnc", aOutput1, aDuration) <= 0) {
            return false;
        }
        return true;
    }
    ...
    public boolean addOreWasherRecipe(ItemStack aInput1, ItemStack aInput2, ItemStack aOutput1, ItemStack aOutput2, ItemStack aOutput3, FluidStack aFluidInput, FluidStack aFluidOutput, int aDuration, int aEUt) {
        ...
        GT_Recipe.GT_Recipe_Map.sOreWasherRecipes.addRecipe(true, new ItemStack[]{aInput1, aInput2}, new ItemStack[]{aOutput1, aOutput2, aOutput3}, null, new FluidStack[]{aFluidInput}, new FluidStack[]{aFluidOutput}, aDuration, aEUt, 0, true);
        return true;
    }
    ...
    public boolean addImplosionRecipe(ItemStack aInput1, int aInput2, ItemStack aOutput1, ItemStack aOutput2) {
        ...
        int tGunpowder = tExplosives;
        int tDynamite = tExplosives;
        int tTNT = Math.max(1, tExplosives / 2);
        int tITNT = Math.max(1, tExplosives / 4);
        int tGlyceryl = Math.max(1, tExplosives / 8);
        if (tDynamite < 65) {
        ...
        if (tScale > 1) {
            ...
            if (aSolidOutput != null) {
                ...
                if (tData != null && (tData.mPrefix == OrePrefixes.dust || OrePrefixes.dust.mFamiliarPrefixes.contains(tData.mPrefix))) {
                    ...
                    if (aSolidOutput.stackSize / tScale == 0) {
                        aSolidOutput = GT_Values.NI;
                    } else {
                        aSolidOutput = new ItemStack(aSolidOutput.getItem(), aSolidOutput.stackSize / tScale);
                    }
                }
            }
    ...
    public boolean addAssemblylineRecipe(ItemStack aResearchItem, int aResearchTime, ItemStack[] aInputs, FluidStack[] aFluidInputs, ItemStack aOutput, int aDuration, int aEUt) {
        addAssemblylineRecipe(aResearchItem, aResearchTime, aInputs, aFluidInputs, aOutput, aDuration, aEUt, false);
        return true;
    }

    @Override
    public boolean addAssemblylineRecipe(ItemStack aResearchItem, int aResearchTime, ItemStack[] aInputs, FluidStack[] aFluidInputs, ItemStack aOutput, int aDuration, int aEUt, boolean addRecyclingRecipes) {
        ...
        if (addRecyclingRecipes) {
            GT_ModHandler.registerItemDataForRecipe(aOutput, aInputs, null);
        }
        return true;
    }
    ...
    @Override
    public boolean addAssemblylineRecipe(ItemStack aResearchItem, int aResearchTime, Object[] aInputs, FluidStack[] aFluidInputs, ItemStack aOutput, int aDuration, int aEUt, boolean addRecyclingRecipes) {
        if ((aResearchItem == null) || (aResearchTime <= 0) || (aInputs == null) || (aOutput == null) || aInputs.length > 15 || aInputs.length < 4) {
            return false;
        }
        if ((aDuration = GregTech_API.sRecipeFile.get("assemblingline", aOutput, aDuration)) <= 0) {
        ...
        if (addRecyclingRecipes) {
            GT_ModHandler.registerItemDataForRecipe(aOutput, tInputs, null);
        }
        return true;
    }
