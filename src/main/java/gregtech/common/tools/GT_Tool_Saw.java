...
public class GT_Tool_Saw
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        ...
        return ((tTool != null) && ((tTool.equals("axe")) || (tTool.equals("saw")))) || (aBlock.getMaterial() == Material.leaves) || (aBlock.getMaterial() == Material.vine) || (aBlock.getMaterial() == Material.wood) || (aBlock.getMaterial() == Material.cactus) || (aBlock.getMaterial() == Material.ice) || (aBlock.getMaterial() == Material.packedIce || (aBlock.getMaterial() == Material.plants) || (aBlock.getMaterial() == Material.leaves));
    }
